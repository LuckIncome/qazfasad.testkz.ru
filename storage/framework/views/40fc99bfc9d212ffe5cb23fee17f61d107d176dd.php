        ...
        <?php $__currentLoopData = $objects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $object): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="object">
            ...
            <div class="object__info">
              <!--<div class="object__info-description"><?php echo e($object->size); ?>м<sup>2</div>-->
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/users/0/004/domains/qaz-fasad.testkz.ru/resources/views/pages/objects/index.blade.php ENDPATH**/ ?>
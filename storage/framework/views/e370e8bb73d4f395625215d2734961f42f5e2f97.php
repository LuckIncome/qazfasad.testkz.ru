...
<section class="products-page">
    <div class="container">
        <div class="nav flex-column nav-pills">
          <?php $__currentLoopData = $productTypes1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="tab-link <?php if($url = URL::current() == route('products.cat', ['category' => $productType->slug])): ?> active <?php endif; ?>" data-bs-toggle="pill" data-bs-target="#v-pills-tab-<?php echo e($productType->sort_id); ?>">
            <a href="/products-category/<?php echo e($productType->slug); ?>"><?php echo e($productType->title); ?></a>
          </div>
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/qazfasad.kz/httpdocs/resources/views/pages/products/index_cat.blade.php ENDPATH**/ ?>
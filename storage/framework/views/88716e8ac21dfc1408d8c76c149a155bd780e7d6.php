        ...
        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>		
			<?php $__currentLoopData = (json_decode($document->file)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="text-end"><a class="btn btn-dark" href="/storage/<?php echo e(utf8_decode($item->download_link)); ?>" style="padding-right:70px;padding-left:70px;" >Скачать</a></td>
                </tr>
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/qazfasad.kz/httpdocs/resources/views/pages/documents.blade.php ENDPATH**/ ?>
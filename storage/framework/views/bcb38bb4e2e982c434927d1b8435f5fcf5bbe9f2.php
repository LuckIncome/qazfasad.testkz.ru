        ...
        <?php $__currentLoopData = $instructions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instruction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>		
			<?php $__currentLoopData = json_decode($instruction->file, false, 512, JSON_UNESCAPED_UNICODE); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="text-end"><a class="btn btn-dark" href="/public/storage/<?php echo e($item->download_link); ?>" style="padding-right:70px;padding-left:70px;">Скачать</a></td>
                </tr>
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/users/0/004/domains/qaz-fasad.testkz.ru/resources/views/pages/instruction.blade.php ENDPATH**/ ?>